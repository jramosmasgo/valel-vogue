            ...
            <Dialog.Overlay className='product-detail-overlay' >
                <Dialog.Content className='product-detail-content'>
                    ...
                    <div className="product-detail-info">
                        ...
                        <p className='product-detail-description'>Nuestra casaca oversized combina estilo contemporáneo con la máxima comodidad. Fabricada con materiales de alta calidad para un ajuste perfecto y duradero.</p>

                        <div className='product-detail-colors'>
                            <span>Colores disponibles:</span>
                            <div className="colors-content">
                                <div className="color-item">Negro <div className="color-box" style={{ background: "black" }}></div></div>
                                <div className="color-item">Blanco <div className="color-box" style={{ background: "white" }}></div></div>
                                <div className="color-item">Rojo <div className="color-box" style={{ background: "#e63946" }}></div></div>
                            </div>
                        </div>
                        ...
                        <p className='product-detail-price'>S/. 107.90</p>
